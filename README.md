...
- `test/merchandiseops/governor_test.cljk` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/merchandiseops/advisor_test.cljk` -- advisor proposal shape and
  consistency
- `test/merchandiseops/phase_test.cljk` -- rollout phase logic
- `test/merchandiseops/governor_contract_test.cljk` -- full graph
  integration, audit trail
- `test/merchandiseops/store_contract_test.cljk` -- Store protocol and
